  ...
  return (
    <div>
     <header className="flex justify-end p-4 bg-transparent relative z-50">
      ...
      <div className="flex flex-col items-center justify-center h-screen bg-custom-gray bg-grid-pattern bg-cover bg-center">
        <div className="main">
      ...
      <section className="bg-custom-gray py-16 px-4 bg-grid-pattern bg-cover bg-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-black mb-4 text-center">About Us</h2>
